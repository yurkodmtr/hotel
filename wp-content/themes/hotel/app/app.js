...
myApp.controller("welcomeController", function ($scope,$http) {
    ...
    $scope.inDateModel;
    $scope.inDateMin = new Date().toString();

    $scope.inDate = new Date();
    $scope.inDate.setDate($scope.inDate.getDate() + 1);
    $scope.inDate = $scope.inDate.toString(); 


    $scope.outDateModel;
    $scope.outDate = new Date();
    $scope.outDate.setDate($scope.outDate.getDate() + 2);
